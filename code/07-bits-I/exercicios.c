...
# define assertEquals(str, a, b) { \
            if ((a) == (b)) { \
                ...
                printf("\033[38;5;1mFAIL: \033[38;5;15m%s\n", str); \
                com_erro = -1; \
            } \
        }
...
int main() {
    ...
    assertEquals("preto", green(0x00000000), 0);
    assertEquals("branco", green(0x00FFFFFF), 0xFF);
    assertEquals("amarelo", green(0x0000FFFF), 0x00);
    assertEquals("laranja?", green(0x00FFFF00), 0xFF);
    assertEquals("numeros", green(0x12345678), 0x34);
    ...
    assertEquals("laranja?", verde_255(0x00FFD212), 0x00FFD212);
    ...
    assertEquals("amarelo", bgr_to_rgb(0x0000FFFF), 0x00FF0000);
